...
// echo "<pre>";
// print_r(realpath(dirname(dirname(dirname(dirname(dirname(dirname(__FILE__))))))). "/data/upload/");
// echo "</pre>";
// die();
...
// $folderPath = '/mvc-cms/public_html/data/upload/';
// $folderPath = str_replace($_SERVER['DOCUMENT_ROOT'],"",__UPLOAD_DATA_PATH);
// $folderPath = str_replace($_SERVER['DOCUMENT_ROOT'],"",__UPLOAD_DATA_PATH);

$folderPath = realpath(dirname(dirname(dirname(dirname(dirname(dirname(__FILE__))))))). "/data/upload/";
$fm = new Filemanager();
